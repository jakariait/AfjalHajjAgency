        ...
        if (res.ok) {
          ...
          gtmPushEvent("form_submission", {
            ...
            message: formData.message,
                  ...
                  console.error("❌ Failed to send message with status:", res.status, errorMessage);
                  setTimeout(() => setErrorMsg(""), 5000);
                }
              } catch (error) {
                setErrorMsg("❌ বার্তা পাঠাতে সমস্যা হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।");
          ...
          // Ensure gtmPushEvent is defined globally if GTM is not loaded immediately
          // or provide a mock for development environments.
          if (typeof window !== "undefined" && !window.gtmPushEvent) {
            window.gtmPushEvent = function() {
              console.warn("gtmPushEvent is not defined. GTM might not be loaded.");
            };
          }
