  ...
  const services = [
    {
      ...
      description:
        "সরকারি নিয়ম অনুযায়ী হজ্জ ও ওমরাহ প্রি-রেজিস্ট্রেশনের সম্পূর্ণ প্রক্রিয়ায় আমরা যাত্রীদের সহায়তা করে থাকি। আবেদন, কাগজপত্র, ফি জমা ও যাচাইকরণ—সবকিছুই আমরা দ্রুত ও নির্ভুলভাবে সম্পন্ন করি।",
    ...
    },
    {
      ...
      description:
        "হজ্জ ও উমরাহ ভিসা প্রক্রিয়ার জন্য প্রয়োজনীয় কাগজপত্র যাচাই, আবেদন প্রক্রিয়া সম্পন্নকরণ এবং ভিসা-সংক্রান্ত সার্বিক সহায়তা প্রদান করা হয়।",
    ...
    },
    {
      ...
      description:
        "বিশ্বস্ত এয়ারলাইন্সের মাধ্যমে সুবিধাজনক সময়সূচি ও প্রতিযোগিতামূলক ভাড়ায় হজ্জ ও উমরাহ যাত্রীদের জন্য ফ্লাইট বুকিং ও রিজার্ভেশন সেবা প্রদান করা হয়।",
    ...
    {
      title: "গাইড ও হজ্জ সহায়তা",
      description:
        "ইহরাম, তাওয়াফ, সাঈ এবং হজ্জ ও ওমরাহর বাদ বাকি ইসলামী বিধিবদ্ধ নিয়ম কানুন ও অন্যান্য ইবাদতের নিয়মকানুন বুঝিয়ে দেয় অভিজ্ঞ আলেমগণ।",
      buttonText: "হজ্জ সহায়তা পেতে যোগাযোগ করুন",
      icon: (
        <svg
          className="w-12 h-12 text-accent"
          fill="none"
    ...
    {
      title: "হজ্জ প্রশিক্ষণ ও প্রস্তুতি",
      description:
        "হজ্জের প্রতিটি ধাপ, দোয়া, করণীয়, বর্জনীয় ও বিধি বিধান নিয়ে সরাসরি প্রশিক্ষণ প্রদান করা হয়।",
      buttonText: "হজ্জ প্রশিক্ষণ পেতে যোগাযোগ করুন",
      icon: (
        <svg
          className="w-12 h-12 text-accent"
          fill="none"
